...
export default function AllPosts() {
  ...
  async function Approve() {
    ...
    setLoading(true)
    await contract.approve("0x5f8677d144E564D9eA9cf83Ce52B69ed320df8Ab", cost)
